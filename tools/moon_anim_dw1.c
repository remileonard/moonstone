...
static const uint8_t dw1_script[] = {  /* LAB_00D8 — 748 bytes, 38 steps */
    ...
    IX_DRAW(3), 0x01, 0xFB, 0x20, 0x00, 0x91, IX_DRAW(3), 0x00, 0xDC, 0x20, 0x00, 0x94,
    IX_DRAW(3), 0x0C, 0xC5, 0x20, 0x00, 0x92, IX_STEP_END, IX_TERM_NEXT,
    /* step 2:  leg=2  flame=11 body_x=+137 */
    IX_DRAW(3), 0x02, 0xFB, 0x20,
    0x00, 0x8E, IX_DRAW(3), 0x00, 0xDD, 0x20, 0x00, 0x89, IX_DRAW(3), 0x0B, 0xC6, 0x20,
    0x00, 0x86, IX_STEP_END, IX_TERM_NEXT,
    /* step 3:  leg=3  flame=10 body_x=+128 */
    IX_DRAW(3), 0x03, 0xFB, 0x20, 0x00, 0x8B, IX_DRAW(3), 0x00,
    0xDD, 0x20, 0x00, 0x80, IX_DRAW(3), 0x0A, 0xC7, 0x20, 0x00, 0x7E, IX_STEP_END, IX_TERM_NEXT,
    /* step 4:  leg=4  flame=9  body_x=+116 */
    IX_DRAW(3), 0x04, 0xFB, 0x20,
    0x00, 0x76, IX_DRAW(3), 0x00, 0xDD, 0x20, 0x00, 0x74, IX_DRAW(3), 0x09, 0xC7, 0x20,
    0x00, 0x73, IX_STEP_END, IX_TERM_NEXT,
    /* step 5:  leg=5  flame=12 body_x=+109 */
    IX_DRAW(3), 0x05, 0xFB, 0x20, 0x00, 0x6C, IX_DRAW(3), 0x00,
    0xDD, 0x20, 0x00, 0x6D, IX_DRAW(3), 0x0C, 0xC7, 0x20, 0x00, 0x6B, IX_STEP_END, IX_TERM_NEXT,
    /* step 6:  leg=6  flame=11 body_x=+100 */
    IX_DRAW(3), 0x06, 0xFB, 0x20,
    0x00, 0x6A, IX_DRAW(3), 0x00, 0xDD, 0x20, 0x00, 0x64, IX_DRAW(3), 0x0B, 0xC5, 0x20,
    0x00, 0x62, IX_STEP_END, IX_TERM_NEXT,
    /* step 7:  leg=7  flame=10 body_x=+90 */
    IX_DRAW(3), 0x07, 0xFB, 0x20, 0x00, 0x65, IX_DRAW(3), 0x00,
    0xDD, 0x20, 0x00, 0x5A, IX_DRAW(3), 0x0A, 0xC5, 0x20, 0x00, 0x58, IX_STEP_END, IX_TERM_NEXT,
    /* step 8:  leg=8  flame=9  body_x=+80 */
    IX_DRAW(3), 0x08, 0xFC, 0x20,
    0x00, 0x52, IX_DRAW(3), 0x00, 0xDE, 0x20, 0x00, 0x50, IX_DRAW(3), 0x09, 0xC7, 0x20,
    0x00, 0x4E, IX_STEP_END, IX_TERM_NEXT,
    /* step 9:  leg=1  flame=9  body_x=+76 */
    IX_DRAW(3), 0x01, 0xFC, 0x20, 0x00, 0x4B, IX_DRAW(3), 0x00,
    0xDE, 0x20, 0x00, 0x4C, IX_DRAW(3), 0x09, 0xC5, 0x20, 0x00, 0x4A, IX_STEP_END, IX_TERM_NEXT,
    /* step 10: leg=2  flame=10 body_x=+68 */
    IX_DRAW(3), 0x02, 0xFC, 0x20,
    0x00, 0x49, IX_DRAW(3), 0x00, 0xDE, 0x20, 0x00, 0x44, IX_DRAW(3), 0x0A, 0xC7, 0x20,
    0x00, 0x43, IX_STEP_END, IX_TERM_NEXT,
    /* step 11: leg=3  flame=11 body_x=+58 */
    IX_DRAW(3), 0x03, 0xFC, 0x20, 0x00, 0x46, IX_DRAW(3), 0x00,
    0xDE, 0x20, 0x00, 0x3A, IX_DRAW(3), 0x0B, 0xC6, 0x20, 0x00, 0x38, IX_STEP_END, IX_TERM_NEXT,
    /* step 12: leg=4  flame=12 body_x=+47 */
    IX_DRAW(3), 0x04, 0xFC, 0x20,
    0x00, 0x32, IX_DRAW(3), 0x00, 0xDE, 0x20, 0x00, 0x2F, IX_DRAW(3), 0x0C, 0xC6, 0x20,
    0x00, 0x2D, IX_STEP_END, IX_TERM_NEXT,
    /* step 13: leg=5  flame=9  body_x=+40 */
    IX_DRAW(3), 0x05, 0xFC, 0x20, 0x00, 0x27, IX_DRAW(3), 0x00,
    0xDE, 0x20, 0x00, 0x28, IX_DRAW(3), 0x09, 0xC6, 0x20, 0x00, 0x26, IX_STEP_END, IX_TERM_NEXT,
    /* step 14: leg=6  flame=10 body_x=+29 */
    IX_DRAW(3), 0x06, 0xFC, 0x20,
    0x00, 0x24, IX_DRAW(3), 0x00, 0xDE, 0x20, 0x00, 0x1D, IX_DRAW(3), 0x0A, 0xC7, 0x20,
    0x00, 0x1B, IX_STEP_END, IX_TERM_NEXT,
    /* step 15: leg=7  flame=11 body_x=+19 */
    IX_DRAW(3), 0x07, 0xFD, 0x20, 0x00, 0x1F, IX_DRAW(3), 0x00,
    0xDF, 0x20, 0x00, 0x13, IX_DRAW(3), 0x0B, 0xC7, 0x20, 0x00, 0x10, IX_STEP_END, IX_TERM_NEXT,
    /* step 16: leg=8  flame=12 body_x=+8 */
    IX_DRAW(3), 0x08, 0xFC, 0x20,
    0x00, 0x0B, IX_DRAW(3), 0x00, 0xDF, 0x20, 0x00, 0x08, IX_DRAW(3), 0x0C, 0xC7, 0x20,
    0x00, 0x06, IX_STEP_END, IX_TERM_NEXT,
    /* step 17: leg=1  flame=9  body_x=+5 */
    IX_DRAW(3), 0x01, 0xFC, 0x20, 0x00, 0x03, IX_DRAW(3), 0x00,
    0xDF, 0x20, 0x00, 0x05, IX_DRAW(3), 0x09, 0xC5, 0x20, 0x00, 0x03, IX_STEP_END, IX_TERM_NEXT,
    /* step 18: leg=2  flame=10 body_x=-4 */
    IX_DRAW(3), 0x02, 0xFC, 0x20,
    0x00, 0x01, IX_DRAW(3), 0x00, 0xDF, 0x20, 0xFF, 0xFC, IX_DRAW(3), 0x0A, 0xC6, 0x20,
    0xFF, 0xFA, IX_STEP_END, IX_TERM_NEXT,
    /* step 19: leg=3  flame=11 body_x=-16 */
    IX_DRAW(3), 0x03, 0xFC, 0x20, 0xFF, 0xFD, IX_DRAW(3), 0x00,
    0xDF, 0x20, 0xFF, 0xF0, IX_DRAW(3), 0x0B, 0xC6, 0x20, 0xFF, 0xEE, IX_STEP_END, IX_TERM_NEXT,
    /* step 20: leg=4  flame=12 body_x=-24 */
    IX_DRAW(3), 0x04, 0xFD, 0x20,
    0xFF, 0xEB, IX_DRAW(3), 0x00, 0xDF, 0x20, 0xFF, 0xE8, IX_DRAW(3), 0x0C, 0xC6, 0x20,
    0xFF, 0xE6, IX_STEP_END, IX_TERM_NEXT,
    /* step 21: leg=5  flame=9  body_x=-30 */
    IX_DRAW(3), 0x05, 0xFC, 0x20, 0xFF, 0xE1, IX_DRAW(3), 0x00,
    0xDE, 0x20, 0xFF, 0xE2, IX_DRAW(3), 0x09, 0xC6, 0x20, 0xFF, 0xE0, IX_STEP_END, IX_TERM_NEXT,
    /* step 22: leg=6  flame=10 body_x=-41 */
    IX_DRAW(3), 0x06, 0xFC, 0x20,
    0xFF, 0xDD, IX_DRAW(3), 0x00, 0xDE, 0x20, 0xFF, 0xD7, IX_DRAW(3), 0x0A, 0xC6, 0x20,
    0xFF, 0xD4, IX_STEP_END, IX_TERM_NEXT,
    /* step 23: leg=7  flame=11 body_x=-49 */
    IX_DRAW(3), 0x07, 0xFC, 0x20, 0xFF, 0xDA, IX_DRAW(3), 0x00,
    0xDE, 0x20, 0xFF, 0xCF, IX_DRAW(3), 0x0B, 0xC5, 0x20, 0xFF, 0xCC, IX_STEP_END, IX_TERM_NEXT,
    /* step 24: leg=8  flame=12 body_x=-59 */
    IX_DRAW(3), 0x08, 0xFC, 0x20,
    0xFF, 0xC7, IX_DRAW(3), 0x00, 0xDE, 0x20, 0xFF, 0xC5, IX_DRAW(3), 0x0C, 0xC6, 0x20,
    0xFF, 0xC2, IX_STEP_END, IX_TERM_NEXT,
    /* step 25: leg=1  flame=9  body_x=-63 */
    IX_DRAW(3), 0x01, 0xFD, 0x20, 0xFF, 0xBF, IX_DRAW(3), 0x00,
    0xDF, 0x20, 0xFF, 0xC1, IX_DRAW(3), 0x09, 0xC6, 0x20, 0xFF, 0xBF, IX_STEP_END, IX_TERM_NEXT,
    /* step 26: leg=2  flame=10 body_x=-71 */
    IX_DRAW(3), 0x02, 0xFD, 0x20,
    0xFF, 0xBD, IX_DRAW(3), 0x00, 0xDF, 0x20, 0xFF, 0xB9, IX_DRAW(3), 0x0A, 0xC6, 0x20,
    0xFF, 0xB7, IX_STEP_END, IX_TERM_NEXT,
    /* step 27: leg=3  flame=11 body_x=-84 */
    IX_DRAW(3), 0x03, 0xFD, 0x20, 0xFF, 0xB8, IX_DRAW(3), 0x00,
    0xDF, 0x20, 0xFF, 0xAC, IX_DRAW(3), 0x0B, 0xC6, 0x20, 0xFF, 0xAA, IX_STEP_END, IX_TERM_NEXT,
    /* step 28: leg=4  flame=12 body_x=-92 */
    IX_DRAW(3), 0x04, 0xFD, 0x20,
    0xFF, 0xA7, IX_DRAW(3), 0x00, 0xDF, 0x20, 0xFF, 0xA4, IX_DRAW(3), 0x0C, 0xC6, 0x20,
    0xFF, 0xA3, IX_STEP_END, IX_TERM_NEXT,
    /* step 29: leg=5  flame=9  body_x=-98 */
    IX_DRAW(3), 0x05, 0xFD, 0x20, 0xFF, 0x9D, IX_DRAW(3), 0x00,
    0xDE, 0x20, 0xFF, 0x9E, IX_DRAW(3), 0x09, 0xC5, 0x20, 0xFF, 0x9C, IX_STEP_END, IX_TERM_NEXT,
    /* step 30: leg=6  flame=10 body_x=-109 */
    IX_DRAW(3), 0x06, 0xFC, 0x20,
    0xFF, 0x9A, IX_DRAW(3), 0x00, 0xDE, 0x20, 0xFF, 0x93, IX_DRAW(3), 0x0A, 0xC5, 0x20,
    0xFF, 0x91, IX_STEP_END, IX_TERM_NEXT,
    /* step 31: leg=7  flame=11 body_x=-118 */
    IX_DRAW(3), 0x07, 0xFC, 0x20, 0xFF, 0x96, IX_DRAW(3), 0x00,
    0xDE, 0x20, 0xFF, 0x8A, IX_DRAW(3), 0x0B, 0xC5, 0x20, 0xFF, 0x88, IX_STEP_END, IX_TERM_NEXT,
    /* step 32: leg=8  flame=12 body_x=-126 */
    IX_DRAW(3), 0x08, 0xFD, 0x20,
    0xFF, 0x84, IX_DRAW(3), 0x00, 0xDF, 0x20, 0xFF, 0x82, IX_DRAW(3), 0x0C, 0xC7, 0x20,
    0xFF, 0x80, IX_STEP_END, IX_TERM_NEXT,
    /* step 33: leg=1  flame=9  body_x=-132 */
    IX_DRAW(3), 0x01, 0xFD, 0x20, 0xFF, 0x7B, IX_DRAW(3), 0x00,
    0xDF, 0x20, 0xFF, 0x7C, IX_DRAW(3), 0x09, 0xC7, 0x20, 0xFF, 0x7A, IX_STEP_END, IX_TERM_NEXT,
    /* step 34: leg=2  flame=10 body_x=-140 */
    IX_DRAW(3), 0x02, 0xFD, 0x20,
    0xFF, 0x79, IX_DRAW(3), 0x00, 0xE0, 0x20, 0xFF, 0x74, IX_DRAW(3), 0x0A, 0xC5, 0x20,
    0xFF, 0x73, IX_STEP_END, IX_TERM_NEXT,
    /* step 35: leg=3  flame=11 body_x=-150 */
    IX_DRAW(3), 0x03, 0xFD, 0x20, 0xFF, 0x76, IX_DRAW(3), 0x00,
    0xDF, 0x20, 0xFF, 0x6A, IX_DRAW(3), 0x0B, 0xC5, 0x20, 0xFF, 0x68, IX_STEP_END, IX_TERM_NEXT,
    /* step 36: leg=4  flame=12 body_x=-162 */
    IX_DRAW(3), 0x04, 0xFD, 0x20,
    0xFF, 0x61, IX_DRAW(3), 0x00, 0xDF, 0x20, 0xFF, 0x5E, IX_DRAW(3), 0x0C, 0xC6, 0x20,
    0xFF, 0x5C, IX_STEP_END, IX_TERM_NEXT,
    /* step 37: leg=5  (no flame)  body_x=-171 */
    IX_DRAW(3), 0x05, 0xFC, 0x20, 0xFF, 0x53, IX_DRAW(3), 0x00,
    0xDE, 0x20, 0xFF, 0x55, IX_STEP_END, IX_TERM_NEXT,
    /* step 38: leg=6  (no flame)  body_x=-181 */
    IX_DRAW(3), 0x06, 0xFC, 0x20,
    0xFF, 0x52, IX_DRAW(3), 0x00, 0xDF, 0x20, 0xFF, 0x4B,
    IX_STEP_END, IX_TERM_SCRIPT_END   /* end of script */
};
